...
#+begin_src emacs-lisp
  ...
  (defun myconfig/set-font-face ()
    ...
    (set-face-attribute 'default nil :font "JetbrainsMono Nerd Font Mono" :height myconfig/default-font-size)
    (set-face-attribute 'fixed-pitch nil :font "JetbrainsMono Nerd Font Mono" :height myconfig/default-font-size)
    (set-face-attribute 'variable-pitch nil :font "JetbrainsMono Nerd Font Mono" :height myconfig/default-variable-font-size :weight 'regular))
